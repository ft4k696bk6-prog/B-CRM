...
create table if not exists public.profiles (
  ...
  constraint profiles_role_check check (role in ('admin', 'handlowiec', 'menadzer', 'ksiegowosc', 'logistyk', 'monter'))
);
...
begin
  if new.raw_user_meta_data ->> 'role' in ('admin', 'handlowiec', 'menadzer', 'ksiegowosc', 'logistyk', 'monter') then
