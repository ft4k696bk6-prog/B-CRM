...
export function StatTile({ label, value, icon: Icon, tone = "sky" }: StatTileProps) {
  return (
    <div className="min-h-[112px] overflow-hidden rounded-lg border border-line bg-white p-4 shadow-sm transition hover:-translate-y-px hover:border-[#c7d1df] hover:shadow-soft sm:min-h-[118px] sm:p-5">
      <div className="flex h-full min-w-0 items-start justify-between gap-3">
        ...
        <div
          className={`flex h-11 w-11 flex-none items-center justify-center rounded-lg border border-line bg-[#f8fafc] shadow-[0_10px_22px_rgba(15,23,42,0.05)] ${toneClasses[tone]}`}
        >
